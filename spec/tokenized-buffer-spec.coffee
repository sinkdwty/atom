    ...
    describe "iterator", ->
      it "iterates over the syntactic scope boundaries", ->
        ...
        expectedBoundaries = [
          ...
          {position: Point(1, 7), closeTags: ["syntax--punctuation syntax--definition syntax--comment syntax--js", "syntax--comment syntax--block syntax--end syntax--js"], openTags: ["syntax--storage syntax--type syntax--var syntax--js"]}
